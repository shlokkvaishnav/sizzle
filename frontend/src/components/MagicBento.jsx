...
/* ══════════════════════════════════════════════
   Sizzle MagicBento (main export)
   ══════════════════════════════════════════════ */

export default function MagicBento({ metrics, secondaryLoaded }) {
    ...
    const cardData = [
        {
            ...
            description: 'Total revenue, margins, WoW/MoM trends & pricing insights',
            label: 'Revenue',
        ...
        },
        {
            color: '#060010',
            title: 'AI Features',
            description: 'Voice ordering, smart combos & menu recommendations',
            label: 'AI',
            kpiValue: null,
            kpiLabel: '',
            to: '/dashboard/voice-order',
        },
        {
            color: '#060010',
            title: 'Menu Insights',
            description: 'Health score, hidden gems, underperformers & drift alerts',
            label: 'Menu',
            kpiValue: metrics?.health_score,
            kpiLabel: 'Health Score',
            formatKpi: v => `${v}/100`,
            to: '/dashboard/menu-analysis',
        },
        {
            color: '#060010',
            title: 'Inventory & Ops',
            description: 'Waste analysis, void tracking & menu complexity',
            label: 'Inventory',
            kpiValue: null,
            kpiLabel: '',
        ...
        },
        {
            ...
            description: 'Return rates, frequent tables & order type breakdown',
            label: 'Customers',
        ...
        },
        {
            ...
            description: 'Seasonal patterns, reports export & system configuration',
            label: 'System',
            kpiValue: null,
            kpiLabel: '',
                ...
                {cardData.map((card, index) => {
                    ...
                    return (
                        <ParticleCard
                            ...
                            enableMagnetism
                        >
                            <div className="magic-bento-card__header" onClick={() => navigate(card.to)}>
                                <div className="magic-bento-card__label">{card.label}</div>
                            </div>
                            <div className="magic-bento-card__content" onClick={() => navigate(card.to)}>
                                <h2 className="magic-bento-card__title">{card.title}</h2>
                                {card.kpiValue != null && card.formatKpi && (
                                    <div className="magic-bento-card__kpi">
                                        <span className="magic-bento-card__kpi-value">{card.formatKpi(card.kpiValue)}</span>
                                        <span className="magic-bento-card__kpi-label">{card.kpiLabel}</span>
                                    </div>
                                )}
